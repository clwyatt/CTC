function [index] = gaselect(fitness, NumSelects, type);		

%GASELECT Given population fitnesses, selects one member
%
% parentindice = gaselect(fitness, 'type','roulette') 
% parentindice = gaselect(fitness, 'tournament') 
% 
...
switch type
 case 'roulette'
    ...
    token  = fitnessLUT(end)*rand(NumSelects,1);
    for i =1:NumSelects
