function SOM_Stats_Pred(data, varargin)
%
...
if Method % GA
	...
	[Max_Model_Test_TruePos,Max_Model_TP_Ind] = max(Model_Test_TruePos);
...
if (FName ~= 0)
  ...
  if Method % GA
      ...
      fprintf(fMask,'\n');
      fprintf(fMask, '%s', ['Max Correct Rate Index: ' num2str(Max_Model_TP_Ind(1))]);
      fprintf(fMask,'\n');   
