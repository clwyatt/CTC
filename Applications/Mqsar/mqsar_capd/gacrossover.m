function [Offspring1, Offspring2, SameFlag] = gacrossover(Parent1, Parent2, pC, varargin);		

% GACROSSOVER Crossover two parent chromosomes to generatetwo childs from
% two parents
%
% [Offspring1, Offspring2, SameFlag] = gacrossover(Parent1, Parent2, pC, 'uniform') 
% [Offspring1, Offspring2, SameFlag] = gacrossover(Parent1, Parent2, 0.7,'point', 4)  
%
