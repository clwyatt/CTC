...
for rr=1:length(worklist)
    ...
    MR_step2_tr = confusion_step_tr(GB,BB); 
    MR_step2_tst = confusion_step_tst(GB,BB);
    MR_pls2_tr = confusion_pls_tr(GB,BB); 
    MR_pls2_tst = confusion_pls_tst(GB,BB);
    MR_gfa2_tr = confusion_gfa_tr(GB,BB); 
    MR_gfa2_tst = confusion_gfa_tst(GB,BB);
    MR_gpls2_tr = confusion_gpls_tr(GB,BB); 
    MR_gpls2_tst = confusion_gpls_tst(GB,BB);
    MR_som2_tr = confusion_som_tr(GB,BB); 
    MR_som2_tst = confusion_som_tst(GB,BB);
    MR_knn2_tr = confusion_knn_tr(GB,BB); 
    MR_knn2_tst = confusion_knn_tst(GB,BB);
    
    Ind_MR2_tr = [MR_step2_tr MR_gpls2_tr MR_gfa2_tr MR_pls2_tr MR_som2_tr MR_knn2_tr];
    Ind_MR2_tr = sum(Ind_MR2_tr(:,Inc2),2);
    Ind_MR2_tst = [MR_step2_tst MR_gpls2_tst MR_gfa2_tst MR_pls2_tst MR_som2_tst MR_knn2_tst];
    Ind_MR2_tst = sum(Ind_MR2_tst(:,Inc2),2);
    ...
    St_MR2_tr(rr) = sum(Ind_MR2_tr > MajLimit);
    St_MR2_tst(rr) = sum(Ind_MR2_tst > MajLimit);
end;    
