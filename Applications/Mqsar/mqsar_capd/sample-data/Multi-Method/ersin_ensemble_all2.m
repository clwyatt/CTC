...
outputfile = 'ensemble_eb3.xls'
classfile = 'ensemble_eb3_class.xls'
...
for rr=1:length(worklist)
    ...
    for xx = 1:Rep
        ...
        rbf = newrb(results_tr(:,Inc)',bioact_tr',0,4,40,40);
        ...
        net2 = train(net2,results_bin_tr',bin_tr');
