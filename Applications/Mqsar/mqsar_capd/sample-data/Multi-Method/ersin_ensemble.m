...
for rr=1:length(worklist)
    ...
    for xx = 1:Rep
        ...
        rbf_ensemble_tr = sim(rbf,results_tr(:,Inc)')';
    ...
    xlswrite(outputfile,F,worksheet,'B2:G12');
    ...
    if ~strcmp(worksheet,'Topliss')
        ...
        xlswrite(outputfile,confusion_avg_ensemble_tr,worksheet,'B44:D46');
        xlswrite(outputfile,confusion_regress_ensemble_tr,worksheet,'B49:D51');
        xlswrite(outputfile,confusion_step_ensemble_tr,worksheet,'B54:D56');
        xlswrite(outputfile,confusion_net_ensemble_tr,worksheet,'B59:D61');
        xlswrite(outputfile,confusion_vote_ensemble_tr,worksheet,'B64:D66');
        xlswrite(outputfile,confusion_rbf_ensemble_tr,worksheet,'B69:D71');
        xlswrite(outputfile,confusion_net2_ensemble_tr,worksheet,'B74:D76');
        ...
        xlswrite(outputfile,confusion_avg_ensemble_tst,worksheet,'G44:I46');
        xlswrite(outputfile,confusion_regress_ensemble_tst,worksheet,'G49:I51');
        xlswrite(outputfile,confusion_step_ensemble_tst,worksheet,'G54:I56');
        xlswrite(outputfile,confusion_net_ensemble_tst,worksheet,'G59:I61');
        xlswrite(outputfile,confusion_vote_ensemble_tst,worksheet,'G64:I66');
        xlswrite(outputfile,confusion_rbf_ensemble_tst,worksheet,'G69:I71');
        xlswrite(outputfile,confusion_net2_ensemble_tst,worksheet,'G74:I76');
    else
        SF3 = {'O1' 'O2' 'O3' 'O4'};
        SF4 = {'A1'; 'A2'; 'A3'; 'A4'};
        ...
        xlswrite(outputfile,confusion_avg_ensemble_tr,worksheet,'B48:E51');
        xlswrite(outputfile,confusion_regress_ensemble_tr,worksheet,'B44:E57');
        xlswrite(outputfile,confusion_step_ensemble_tr,worksheet,'B60:E63');
        xlswrite(outputfile,confusion_net_ensemble_tr,worksheet,'B66:E69');
        xlswrite(outputfile,confusion_vote_ensemble_tr,worksheet,'B72:E75');
        ...
        xlswrite(outputfile,confusion_avg_ensemble_tst,worksheet,'H48:K51');
        xlswrite(outputfile,confusion_regress_ensemble_tst,worksheet,'H54:K57');
        xlswrite(outputfile,confusion_step_ensemble_tst,worksheet,'H60:K63');
        xlswrite(outputfile,confusion_net_ensemble_tst,worksheet,'H66:K69');
        xlswrite(outputfile,confusion_vote_ensemble_tst,worksheet,'H72:K75');
        xlswrite(outputfile,confusion_rbf_ensemble_tst,worksheet,'H78:K81');
        xlswrite(outputfile,confusion_vote_ensemble_tst,worksheet,'H84:K87');
        
    end;
    
    xlswrite(outputfile,SF,worksheet,'B1:G1');

    xlswrite(outputfile,SF2,worksheet,'A2:A12');
