...
public class CTCSMOTEFilterTest 
{
    private CTCSMOTEFilter filter;
    ...
    public void setUp() throws Exception
    {
		...
		filter.setKNN(3);  // for weather.arff, there are only 5 instances for class "no"
    }
    ...
    @Test public void test3() throws Exception
    {
		...
		// these instances are synthesized, should be unique (depend on the randomness)
		assertTrue(WEKAutil.indexOf(insts_filter_3, insts_filter_3.instance(14)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_3, insts_filter_3.instance(15)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_3, insts_filter_3.instance(16)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_3, insts_filter_3.instance(17)).length == 1);
    }	
    ...
    @Test public void test4() throws Exception
    {
		...
		// these instances are synthesized, should be unique (depend on the randomness)
		assertTrue(WEKAutil.indexOf(insts_filter_4, insts_filter_4.instance(14)).length == 1);
    }	
    ...
    @Test public void test5() throws Exception
    {
		...
		// these instances are synthesized, should be unique (depend on the randomness)
		assertTrue(WEKAutil.indexOf(insts_filter_5, insts_filter_5.instance(14)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_5, insts_filter_5.instance(15)).length == 1);
    }
    ...
    @Test public void test6() throws Exception
    {
		...
		// these instances are synthesized, should be unique (depend on the randomness)
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(9)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(15)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(16)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(17)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(18)).length == 1);
		assertTrue(WEKAutil.indexOf(insts_filter_6, insts_filter_6.instance(19)).length == 1);
    }
