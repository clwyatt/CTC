...
template<class TInputImage,
  class TOutputImage,
  class TInputFilter=ImageToImageFilter< OrientedImage< typename TInputImage::PixelType, TInputImage::ImageDimension - 1 >,  Image< typename TOutputImage::PixelType, TOutputImage::ImageDimension - 1 > >,
