...
/* Yuan  */
    float E,F,G,L,M,N,R,hmag,P1,P2,K,H,K1,K2,SI,CV;
	...
	if(bit.GetPixel(center) == 0)
	  {	
	    int count = 0;
     //AssociatedFeatureVector::Pointer FeaturesList = AssociatedFeatureVector::New();
...
/* Yuan */
     ...
     R = g[2]*g[2]*sqrt(hmag);
     L = (2*g[0]*g[1]*f1[2] - g[0]*g[0]*f1[5] - g[2]*g[2]*f1[0]) / R;
     M = (g[0]*g[2]*f1[4] + g[1]*g[2]*f1[2] - g[0]*g[1]*f1[5] - g[2]*g[2]*f1[1]) / R;
     N = (2*g[1]*g[2]*f1[4] - g[1]*g[1]*f1[5] - g[2]*g[2]*f1[3]) / R;
