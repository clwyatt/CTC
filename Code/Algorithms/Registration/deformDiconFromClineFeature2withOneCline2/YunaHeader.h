...
typedef itk::Image< DistanceMapPixelType,  Dimension >   DMapInputImageType;
typedef itk::ImageFileReader< DMapInputImageType  >  DMapReaderType;

typedef itk::ImageRegionConstIterator< DMapInputImageType > DMapConstIteratorType;
