...
class GroupObjVoxel{
	public:
	 ...
	 public:
		  ...
		  int CountSrcAndTrgFloatObj(TNT::Array3D<float> &Src, float srcThreshold, TNT::Array3D<float> &Trg, float trgThreshold, int dimx, int dimy, int dimz);
		  void fillGroupObjVoxelFloatObj(int num, TNT::Array3D<float> &Src, float srcThreshold, TNT::Array3D<float> &Trg, float trgThreshold, int dimx, int dimy, int dimz);
		  void fillGroupObjVoxelFloat(unsigned long int num, TNT::Array3D<float> &bVoxel, int dimx, int dimy, int dimz);
};
