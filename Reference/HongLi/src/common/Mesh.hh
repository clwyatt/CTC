...
private:
	...
	public:
		...
		typedef std::slist<Vertex *>::iterator iterator;

	private:

		bool shared;

		std::slist<Vertex *> linearList;
	...
	std::slist<Triangle> triangles;
	std::vector<Triangle> finalTlist;

	/// is the list of triangles an slist (best for Mesh construction) or vector (best for mesh computations)
	bool finalized;
